...
class Search extends CI_Controller {
    ...
    public function index($name = NULL, $isbn = NULL,
                        $module = NULL, $details = NULL,
                        $price = NULL)
    {
        ...
        $transactions = array($testTransaction1, $testTransaction3, 
                             $testTransaction5, $testTransaction6);
